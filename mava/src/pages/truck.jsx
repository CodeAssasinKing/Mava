...
function Truck() {
    ...
    const [camPos, setCamPos] = useState([-5, 0.2, 3]);
    ...
    useEffect(() => {
        ...
        if (!div_ref.current) return;    // защита
            ...
            {/* liquid glass панель справа (Bootstrap) — показываем после загрузки */}
                ...
                >
                  ...
                  MAVA Logistics
                            ...
                            >
                                Scania R-series in extreme conditions
                            </h2>
                            ...
                            >
                                Reliable transport for long-distance routes, tested on ice and gravel.
                                Stable performance, precise timing, and full control over your cargo.
                            </p>

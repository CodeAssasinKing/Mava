...
function Car() {
    ...
    const [camPos, setCamPos] = useState([-5, 2, 7]);
    const [camTarget, setCamTarget] = useState([-1, 0, 0]);
    ...
    return (
        <>
            ...
            >
                ...
                <Suspense fallback={null}>
                    <Model
                        url={"/models/airplane/scene.gltf"}
                        position={[-3, 0.3, 0]}
                        rotation={[0, 1, 0]}
                        scale={[2, 2, 2]}
                    />
        ...
        >
          ...
          MAVA Logistics
                        ...
                        >
                            Air cargo for urgent international deliveries
                        </h2>
                        ...
                        >
                            Fast and secure air transport for time-critical cargo. Optimized routes,
                            customs support, and live tracking to keep every shipment under control
